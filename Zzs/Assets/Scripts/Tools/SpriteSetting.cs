...
[CreateAssetMenu(fileName = "new Paramenters", menuName = "SpriteSetting", order = 1)]
...
public class ModifyFilesInBulk : EditorWindow
{
    ...
    void OnGUI()
    {
        SpriteSetting parametersConfig = AssetDatabase.LoadAssetAtPath<SpriteSetting>(AssetInfo.JPGSettingPath) as SpriteSetting;
    ...
    //根据设置 更新序列化信息
    public void SetAllparameters(SpriteSetting parametersConfig)
    {
    ...
    public void LoadStartParameters(SpriteSetting parametersConfig)
    {
    ...
    //操作文件夹
    public void SetTexture(FileInfo[] fileInfo)
    {
    ...
    public void SetPlatformSettings(TextureImporter importer)
    {
        SpriteSetting parametersConfig = AssetDatabase.LoadAssetAtPath<SpriteSetting>(AssetInfo.JPGSettingPath) as SpriteSetting;
